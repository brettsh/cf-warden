...
| EMAIL_TO      | [you@example.com](mailto:you@example.com)       | Alert recipient                                                                              |
| EMAIL_FROM    | [alerts@example.com](mailto:alerts@example.com) | From address                                                                                 |
...
| SMTP_USERNAME | [user@example.com](mailto:user@example.com)     | SMTP login username (optional)                                                               |
...
| COOLDOWN_SEC        | 300     | Seconds to wait after switching before switching back |
| ALERT_COOLDOWN_SEC  | 300     | Seconds between repeat alert emails during an attack  |
